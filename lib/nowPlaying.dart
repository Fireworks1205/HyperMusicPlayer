      ...
      body:  SafeArea(
        child: Column(
          children: <Widget>[
            Container(
              width: 500,
              child: _songs[curIdx].albumArt != null ? Image.file(File.fromUri(Uri.parse(_songs[curIdx].albumArt))) : Image.asset('lib/asdf.png')
            ),
            Expanded(
              child: Container(
                width: 500,
                  ...
                  children: <Widget>[
                    Column(
                      children: <Widget>[
                        ...
                        Text(_songs[curIdx].title,  style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold),),
